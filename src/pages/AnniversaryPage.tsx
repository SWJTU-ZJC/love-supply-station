          ...
          return (
            ...
            >
              <span className="text-2xl">
                {isPixel ? (
                  <PixelSprite name={typePixelSprites[item.type]} size={60} />
                ) : isAnimal ? (
          ...
          >
            ...
            <div className="flex gap-2 mb-3">
              {(Object.entries(typeLabels) as [typeof formType, string][]).map(([t, label]) => (
                ...
                >
                  {isPixel ? <PixelSprite name={typePixelSprites[t]} size={44} /> : isAnimal ? <AnimalIcon name={typeIcons[t]} size={18} /> : typeEmojis[t]} {label}
                </button>
              ))}
            </div>
