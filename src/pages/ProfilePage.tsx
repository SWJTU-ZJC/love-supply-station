    ...
    <div className="page-enter px-5 pt-8 pb-4 space-y-6">
      ...
      <div className="bg-white rounded-card p-5 shadow-soft">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full bg-sunset/20 flex items-center justify-center text-2xl">
              🪙
            </div>
            <div>
              <p className="text-2xl font-bold text-sunset">{user.coins}</p>
              <p className="text-text-secondary text-xs">金币余额</p>
            </div>
          </div>
          <button
            onClick={dailyLogin}
            className="px-4 py-2 rounded-btn bg-sunset/10 text-sunset text-sm font-semibold
                     hover:bg-sunset/20 transition-colors"
          >
            每日签到 +5
          </button>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-white rounded-card p-4 shadow-soft text-center">
          ...
          <p className="text-xl font-bold text-blush">0</p>
          <p className="text-text-secondary text-xs">转盘次数</p>
        </div>
        <div className="bg-white rounded-card p-4 shadow-soft text-center">
          <div className="text-3xl mb-1">🥚</div>
          <p className="text-xl font-bold text-sunset">0</p>
          <p className="text-text-secondary text-xs">扭蛋次数</p>
        </div>
        <div className="bg-white rounded-card p-4 shadow-soft text-center">
          <div className="text-3xl mb-1">📍</div>
          <p className="text-xl font-bold text-calm">0</p>
          <p className="text-text-secondary text-xs">打卡地点</p>
        </div>
        <div className="bg-white rounded-card p-4 shadow-soft text-center">
          <div className="text-3xl mb-1">✅</div>
          <p className="text-xl font-bold text-mint">0</p>
      ...
      <div className="bg-white rounded-card p-5 shadow-soft">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-text-secondary text-sm">心情：{partner.mood}</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-card shadow-soft overflow-hidden">
        <button className="w-full flex items-center gap-3 px-5 py-4 hover:bg-apricot/30 transition-colors
                         border-b border-apricot/30">
